...
<h4 align="center">
    <p>
        <b>简体中文</b> |
        <a href="https://github.com/superbot-ai445/nonebot-plugin-nailongremove/blob/main/i18n/README_en.md">English</a> |
    </p>
</h4>
...
- [run_with_napcat.ipynb](https://github.com/superbot-ai445/nonebot-plugin-nailongremove/blob/main/ipynb/run_with_napcat.ipynb)文件，支持Kaggle或者Huggingface的Space等一键部署，仅需点击运行和扫码即可完成bot部署！
- 支持[Docker](https://github.com/superbot-ai445/nonebot-plugin-nailongremove/tree/main/docker)一键部署

### 2.本地部署

**如果你从来没接触过
NoneBot，请查看 [这个文档](https://github.com/superbot-ai445/nonebot-plugin-nailongremove/blob/main/docs/tutorial.md)**
...
- 增加[run_with_napcat.ipynb](https://github.com/superbot-ai445/nonebot-plugin-nailongremove/blob/main/ipynb/run_with_napcat.ipynb)文件，支持Kaggle或者Huggingface的Space等一键部署，仅需点击运行和扫码即可完成bot部署！
- 增加[Docker](https://github.com/superbot-ai445/nonebot-plugin-nailongremove/tree/main/docker)一键部署
